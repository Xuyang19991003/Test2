...
def get_method_proference(method):
    #英文的是(42, 11)
    figure, axes = plt.subplots(1, 4, sharex="none", sharey="none", figsize=(42, 12))
    ...
    for data in dataset_list:
        ...
        if data=="DS-small":
            #英文的是(1.25, -0.42)
            #中文的是（(1.25, -0.38)）
            ax.legend(loc='lower center', bbox_to_anchor=(1.25, -0.38),ncol=3,prop={'size': 35})
